...
Dosemap shape matches density shape (z,y,x)	 for Dataset5 (131, 256, 256)
...
directory_path =  '/gpfs001/scratch/schwar14/simudosemapheavyions/DosemapInBrain/build_folders/Leo/'
print('conversion files from ',directory_path)
# Save path
save_path = '/scratch/tappay01/data/data5'

# Iterate through files in the folder
for filename in os.listdir(directory_path):
    if filename.endswith('.out') and filename.startswith('Data5'):
        # Start the timer
